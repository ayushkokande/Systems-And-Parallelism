"""
CS336 a2 (Systems & Parallelism) — GPU performance dashboard.
...
with gr.Blocks(title="CS336 a2 — GPU Performance Dashboard", theme=gr.themes.Soft()) as demo:
    gr.Markdown(INTRO)
    ...
    gr.Markdown(
        "<sub>Source: `student/batch_results/`. Charts: Plotly. "
        "Built from the CS336 a2 systems assignment.</sub>"
    )
